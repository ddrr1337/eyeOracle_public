...
contract MMKToken is ERC20, ConfirmedOwner {
    ...
    modifier onlyAllowedMinter() {
        require(
            IdStockStorage(storageAddress).allowedMinters(msg.sender),
            "Only alowed minter can call this function"
        );
        _;
    }
    ...
    ) ERC20("MidnighMarkets", "MMK") ConfirmedOwner(msg.sender) {
    ...
    function getStocksCount() public view returns (uint256) {
        address[] memory stocks = IdStockStorage(storageAddress)
            .getStocksArray();
